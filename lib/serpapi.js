const SERPAPI_KEY = '1367b608124e5bb349fe5f3c0292f6cf8f9c43ee5173a98b54993bf9d921418d'; // Get from https://serpapi.com/
...
const parseEventResults = (results, artistName) => {
  ...
  if (results.organic_results) {
    results.organic_results.forEach(result => {
      ...
      const venuePattern = /(at|@)\s+([A-Z][a-zA-Z\s&]+(?:venue|bar|club|hall|center|centre|theater|theatre))/i;
